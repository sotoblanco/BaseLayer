...
import { buildLearningCourse, type BuildCourseResult } from '../services/aiService';
      ...
      <div className="w-full max-w-xl rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-start justify-between border-b border-slate-800 p-6 bg-slate-900/90">
          <div className="flex gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Agentic Course Builder</h2>
              <p className="mt-1 text-xs text-slate-400">
                4-step Solveit workflow: Intent → Profile → Platform Tools → Curated Lessons
              </p>
            </div>
          </div>
          <button
